    ...
    for (i,c) in enumerate(counterShape):
        ...
        for (x,y) in detect:
            if y<(count_line_positon+offset) and y>(count_line_positon-offset):
                counter+=1
                cv2.line(frame1,(25,count_line_positon),(1200,count_line_positon),(0,127,255),3)
                detect.remove((x,y))
                print("Vehicle Counter : "+str(counter))


    cv2.putText(frame1,"VEHICLE COUNTER : "+str(counter),(45,70),cv2.FONT_HERSHEY_SIMPLEX,2,(0,0,255),5)
